...
for lineid, f in enumerate(french):
  ...
  # this so that they can represent translations of *any* i words.
    ...
    init_bit = 0
    hypothesis = namedtuple("hypothesis", "logprob, lm_prob, tm_prob, lm_state, bit_string, predecessor, start_idx, phrase")
    initial_hypothesis = hypothesis(0.0, 0.0, [0.0]*4, lm.begin(), 0, None, 0, None)
    stacks = [{} for _ in f] + [{}]
        ...
        #for j in xrange(i+1,len(f)+1):
            ...
            for phrase_i, phrase_idx in zip(phrase, phrase_idx1):
                ...
                for phrase1 in tm[phrase_i]:
                    ...
                    logprob = h.logprob + sum(map(mul, w[1:], phrase1.probs))
                    lm_state = h.lm_state
                    ...
                    new_hypothesis = hypothesis(logprob, lm_prob, tm_prob, lm_state, bit_string, h, phrase_idx[-1] + 1, phrase1)
